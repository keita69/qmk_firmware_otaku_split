...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     /* Qwerty
     * ,----------------------------------------------------------------------------------------------------------------------.
     * | ESCx2|   1  |   2  |   3  |   4  |   5  |SD_GRV3|||||||   6   |   7  |   8  |   9  |   0  |   -  |   =  |   \  |  `   |
     * |------+------+------+------+------+------+------+--------------+------+------+------+------+------+------+------+------|
     ...
     */
  [_QWERTY] = LAYOUT(
			ESCx2  , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , SD_GRV3,      KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL  , KC_BSLS, KC_GRV,
  ...
  [_LOWER] = LAYOUT(
			...
			KC_TAB , KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, _______,      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS , KC_ENT ,
