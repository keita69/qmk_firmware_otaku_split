...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     /* Qwerty
     * ,----------------------------------------------------------------------------------------------------------------------.
     * | ESC  |   1  |   2  |   3  |   4  |   5  |K8SCTL||||||||   6  |   7  |   8  |   9  |   0  |   -  |   =  |   \  |  `   |
     * |------+------+------+------+------+------+------+-------------+------+------+------+------+------+------+------+------|
     ...
     * |-------------+------+------+------+------+------+------+------+------|------+------+------+------+------+-------------|
     * | Ctrl | GUI  | Alt  | Space| EISU | Lower|   -  ||||||||||||||| Bksp | Raise|AltTab| GUI  |GUI_UP|GUI_DW|CLATDL| Ctrl |
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
  [_QWERTY] = LAYOUT(
			KC_ESC , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , K8SCTL   ,    KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL  , KC_BSLS, KC_GRV,
			...
			KC_LCTL, KC_LGUI, KC_LALT, KC_SPC , EISU   , LOWER  , KC_MINS,      KC_BSPC, RAISE  , ALT_TB , KC_RGUI, GUI_RT , GUI_UP , CLALDL  , KC_RCTL
  ),
     /* Lower
     * ,----------------------------------------------------------------------------------------------------------------------.
