...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------------+------+------+------+------+------+------+-------+------|------+------+------+------+------+-------------|
     * |GUI_LT| GUI  | Alt  | Alt  |AltTab| Lower| Del  |||||||||||||||| Bksp | Raise| EISU | GUI  |GUI_RT|GUI_UP|GUI_RT|CLALDL|
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
  [_QWERTY] = LAYOUT(
			...
			GUI_LT , KC_LGUI, KC_LALT, KC_LALT, ALT_TB , LOWER  , KC_DEL ,      KC_BSPC, RAISE  , EISU   , KC_RGUI, GUI_RT , GUI_UP , GUI_RT  , CLALDL
  ),
     /* Lower
     * ,----------------------------------------------------------------------------------------------------------------------.
     * | ESCx2|  F1  |  F2  |  F3  |  F4  |  F5  |  F6  ||||||||  F6  |  F7  |  F8  |  F9  | F10  | F11  | F12  |      |      |
     * |------+------+------+------+------+------+------+-------------+------+------+------+------+------+------+------+------|
     * | Tab  |   1  |   2  |   3  |   4  |   5  |   6  ||||||||   6  |   7  |   8  |   9  |   0  |      |      |    Enter    |
     * |------+------+------+------+------+------+------+-------------+------+------+------+------+------+------+------+      |
     * | Ctrl |      |      |      |      |      ||||||||||||||||||||||      |      |      |      |      |      |      |      |
     * |------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------+------|
     * | Shift|      |      |      |      |      ||||||||||||||||||||||      |      |      |      |      |      |      |      |
     * |-------------+------+------+------+------+------+------+------+------|------+------+------+------+------+-------------|
     * |CL_G_L|      |      |      |      | Lower| Space||||||||||||||| Bksp | Raise|      |      |      |      |CL_G_R|      |
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
  [_LOWER] = LAYOUT(
			ESCx2  , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  ,      KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12  , _______, _______,
			KC_TAB , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   ,      KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______, _______ , KC_ENT ,
			...
			CL_G_L , _______, _______, _______, _______, LOWER  , KC_SPC ,      KC_BSPC, RAISE  , _______, _______, _______, _______, CL_G_R  , _______
  ),
     /* Raise
     * ,----------------------------------------------------------------------------------------------------------------------.
     ...
     * |-------------+------+------+------+------+------+------+------+------|------+------+------+------+------+-------------|
     * |GUI_DW|      |      |             | Lower| Space||||||||||||||| Bksp | Raise|      |      |      |      |GUI_UP|      |
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
  [_RAISE] = LAYOUT(
			...
			KC_LSFT, _______, _______, _______, _______, _______,               KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_HOME, KC_END , _______ , _______,
			GUI_DW ,_______,  _______, _______, _______, LOWER  , KC_SPC ,      KC_BSPC, RAISE  , _______, _______, _______, _______, GUI_UP  , _______
  ),
      /* Adjust
     * ,----------------------------------------------------------------------------------------------------------------------.
     * |      |      |      |      |      |      |      ||||||||      |      |      |      |      |      |      |      |      |
