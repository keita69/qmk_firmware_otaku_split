...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     /* Qwerty
     * ,----------------------------------------------------------------------------------------------------------------------.
     * | ESC  |   1  |   2  |   3  |   4  |   5  |   6  ||||||||K8SCTL|   7  |   8  |   9  |   0  |   -  |   =  |   |  |  `   |
     * |------+------+------+------+------+------+------+-------------+------+------+------+------+------+------+------+------|
     * | Tab  |   Q  |   W  |   E  |   R  |   T  | Del  ||||||||   Y  |   U  |   I  |   O  |   P  |   [  |  ]   |    Enter    |
     * |------+------+------+------+------+------+------+-------------+------+------+------+------+------+------+------+      |
     ...
     */
  [_QWERTY] = LAYOUT(
			KC_ESC , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   ,      K8SCTL , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL  , KC_JYEN, KC_BSPC,
     ...
     */
  [_LOWER] = LAYOUT(
			KC_ESC , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  ,      _______, KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12  , _______, _______,
     ...
     * |------+------+------+------+------+------+------+-------------+------+------+------+------+------+------+------+      |
     * | Ctrl |      |      |      |      |      |||||||||||||||||||||| Left | Down |  Up  | Right| Home | End  |WinApp|      |
     * |------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------+------|
     * | Shift|      |      |      |      |      ||||||||||||||||||||||WhLeft|WhDown| WhUp |WhRght|      |      |      | Shift|
     * |-------------+------+------+------+------+------+------+------+------|------+------+------+------+------+-------------|
     * | Ctrl | GUI  | Alt  |    Space    | Lower| Space||||||||||||||| Bksp | Raise|AltTab| GUI  |GUI_UP|GUI_DW|CLATDL| Ctrl |
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
  [_RAISE] = LAYOUT(
			...
			KC_LCTL, _______, _______, _______, _______, _______,               KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_HOME, KC_END , KC_APP  ,
			KC_LSFT, _______, _______, _______, _______, _______,               KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______, _______, _______ , KC_RSFT,
			KC_LCTL, KC_LGUI, KC_LALT, KC_SPC , KC_SPC , LOWER  , KC_SPC ,      KC_BSPC, RAISE  , ALT_TB , KC_RGUI, GUI_RT , GUI_UP , CLALDL  ,  KC_RCTL
  ),
      /* Adjust
     * ,----------------------------------------------------------------------------------------------------------------------.
