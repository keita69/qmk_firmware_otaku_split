...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------------+------+------+------+------+------+------+-------+------|------+------+------+------+------+-------------|
     * | Ctrl | GUI  | Alt  | Space| EISU | Lower| Del  |||||||||||||||| Bksp | Raise|AltTab| GUI  |GUI_UP|GUI_DW|CLATDL| Ctrl |
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
  [_QWERTY] = LAYOUT(
			...
			KC_LCTL, KC_LGUI, KC_LALT, KC_SPC , EISU   , LOWER  , KC_DEL ,      KC_BSPC, RAISE  , ALT_TB , KC_RGUI, GUI_RT , GUI_UP , CLALDL  , KC_RCTL
  ),
     /* Lower
     * ,----------------------------------------------------------------------------------------------------------------------.
